...
public class ScheduleDTO {
    ...
    private List<ScheduledMealDTO> scheduledMeals;
    ...
    public List<ScheduledMealDTO> getScheduledMeals() {
        return scheduledMeals;
    }
    
    public void setScheduledMeals(List<ScheduledMealDTO> scheduledMeals) {
